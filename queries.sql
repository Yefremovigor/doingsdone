...
VALUES ('yefremovigor@yandex.ru', 'Игорь', 'password'),
...
VALUES ('Собеседование в IT компании', 1, 3, 0, '2021.07.17', null, null),
...
SELECT name, project_id, status, DATE_FORMAT(do_date, '%d.%m.%Y') AS do_date, file
FROM tasks
WHERE user_id = 1;
