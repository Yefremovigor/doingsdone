...
VALUES
       ('Собеседование в IT компании', 1, 3, 0, '2021.07.17', null),
       ('Выполнить тестовое задание', 1, 3, 0, '2021.08.25', null),
       ('Сделать задание первого раздела', 1, 2, 1, '2021.08.21', null),
       ('Встреча с другом', 1, 1, 0, '2021.07.20', null),
